...
ROOT_DIR = environ.Path(
    __file__) - 3  # (bitxconvert/config/settings/base.py - 3 = bitxconvert/)
APPS_DIR = ROOT_DIR.path('bitxconvert')
...
MIGRATION_MODULES = {
    'sites': 'bitxconvert.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Mark Tripoli""", 'mark.tripoli@trievosoftware.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'bitxconvert.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
BINANCE_CONVERT_FILE_TYPES = ['.xls', '.xlsx']
BITTREX_CONVERT_FILE_TYPES = ['.xlsx']
COINBASE_CONVERT_FILE_TYPES = ['.xlsx']

CONVERT_BTC_LIMIT = 10
